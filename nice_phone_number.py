...
def sum_phone_degit(phone_number: str):
    total = 0
    for c in phone_number:
        total += int(c)
    return total

def interpret(number:str):
    meaning = ""
...
# print(sum_phone_degit("123"))
# n = sum_phone_degit("0882117904")
# print(n)
# print(interpret(n))

phone = input("Enter your phone number : ")
print(interpret(sum_phone_degit(phone)))
