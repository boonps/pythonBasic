# การใช้เมธอด add(), update(), remove(), discard()
# เทคนิคการประยุกต์ใช้ intersection, subset ในการเทียบคุณสมบัติของผู้สมัครว่าผ่านเกณฑ์ที่กำหนดหรือไม่
# การค้นหาและปรับปรุงข้อมูลใน set
